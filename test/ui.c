...
lv_obj_t * ui_lblMax;
lv_obj_t * ui_lblMin;
lv_obj_t * ui_PanelActualValueLiter;
...
lv_obj_t * ui_PanelGraphValue;
lv_obj_t * ui_GraphValue;
lv_obj_t * ui_lblH1;
lv_obj_t * ui_lblPer;
...
lv_obj_t * ui_btnCilinder;
lv_obj_t * ui_Label42;
void ui_event_BtnRectangle(lv_event_t * e);
lv_obj_t * ui_BtnRectangle;
lv_obj_t * ui_Label43;
...
lv_obj_t * ui_Info;
lv_obj_t * ui_TopInfoBar6;
lv_obj_t * ui_Spinner7;
...
void ui_event_BtnRectangle(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        funcTankTypeChangedRectangle(e);
    }
}
void ui_event_TextAreaRectangleWide(lv_event_t * e)
{
